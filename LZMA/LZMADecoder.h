...
#include "./7zip/Compress/LZ/LZOutWindow.h"
#include "./7zip/Compress/RangeCoder/RangeCoderBitTree.h"
...
public:
  ...
  void SetDictionarySize(int powerOfTwo);

  UInt32 _numLiteralPosStateBits;
  UInt32 _numLiteralContextBits;
  UInt32 _dictionarySize;
#define D_kDefaultDictionaryLogSize 23

  CDecoder(): 
  _posStateMask(4 - 1),
  _numLiteralPosStateBits(0),
  _numLiteralContextBits(3),
  _dictionarySize(1 << D_kDefaultDictionaryLogSize),
