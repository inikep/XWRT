...
#include "./7zip/Compress/LZ/BinTree/BinTree2.h"
#endif
#ifdef COMPRESS_MF_BT3
#include "./7zip/Compress/LZ/BinTree/BinTree3.h"
#endif
#ifdef COMPRESS_MF_BT4
#include "./7zip/Compress/LZ/BinTree/BinTree4.h"
#endif
#endif

#ifdef COMPRESS_MF_HC
#include "./7zip/Compress/LZ/HashChain/HC4.h"
#endif

#ifdef COMPRESS_MF_MT
#include "./7zip/Compress/LZ/MT/MT.h"
#endif
...
const int kDefaultDictionaryLogSize = 23;
...
CEncoder::CEncoder():
  ...
  _writeEndMark(false)
{
  _fastMode = false; // algorithm==2
  _matchFinderCycles=16 + _numFastBytes / 2;
//  _numFastBytes=32;
//  _matchFinderCycles=0;
}


void CEncoder::SetDictionarySize(int powerOfTwo)
{
  _dictionarySize=1 << powerOfTwo;
  _distTableSize=powerOfTwo*2;
}
